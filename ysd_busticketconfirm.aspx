<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="ysd_busticketconfirm.aspx.cs" Inherits="ysd_busticketconfirm" %>
   ...
   <br />
    ...
    <table class="auto-style1"  style="border-bottom:1px solid white">
        <tr>
            ...
            <td>
                <asp:Label ID="Label2" runat="server" Font-Bold="True" Font-Names="Bell MT" Font-Size="X-Large" ForeColor="#CC3300" Text="YSD BUS BOOKING" Font-Underline="True"></asp:Label>
            </td>
        </tr>
    </table>
